...
const Register = () => {
  ...
  const handleOTPVerification = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch('http://localhost:5000/employee/verifyotp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const handleResentOTP = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch('http://localhost:5000/employee/resendotp', {
        method: 'POST',
        headers: {
          "Content-Type": "application/json"
        },
            ...
            <div className="col-lg-5 col-sm-12 bg-light">
              {
                isOTPVerificationEnabled ? (
                  ...
                  <form className='p-3' onSubmit={handleRegistration}>
                    ...
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Comapany Email </label>
