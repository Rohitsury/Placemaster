            ...
            <div className="row loginsection-row shadow" data-aos="zoom-in">
              <div className="col-lg-5 col-sm-12 bg-light">
                ...
                <form className='p-4' onSubmit={handleSubmit}>
                  ...
                  <Link onClick={Opendiv} >Forgot Password</Link>
              ...
              <div className="col-lg-7 p-0 col-sm-12 imgcol">
                <img src={login} alt="" className='  loginimg' style={{ maxHeight: "72vh", width: '100%' }} />
              </div>
            </div>
